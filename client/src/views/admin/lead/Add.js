    ...
    <div>
      <Drawer isOpen={props?.isOpen} size={props?.size}>
        ...
        <DrawerContent>
          ...
          <DrawerBody>
            <CustomForm moduleData={props?.leadData} form={formik} />
              ...
              <GridItem colSpan={{ base: 12 }}>
                ...
                <Flex justifyContent="space-between">
                  <Select
                    ...
                    mb={
                      errors?.associatedListing && touched?.associatedListing ? undefined : "10px"
                    }
                    fontWeight="500"
                    placeholder={t?.("modules.lead.placeholders.associatedListing")}
                    borderColor={
                      errors?.associatedListing && touched?.associatedListing ? "red.300" : null
                    }
                  >
            ...
            <Grid templateColumns="repeat(12, 1fr)" gap={3} mt={2}>
              <GridItem colSpan={{ base: 12 }}>
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {errors?.assignUser && touched?.assignUser && errors?.assignUser}
                </Text>
              </GridItem>
            </Grid>
          </DrawerBody>
