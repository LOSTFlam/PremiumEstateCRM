...
import { getApi, deleteManyApi, putApi } from "services/api";
            ...
            <Grid gap={4}>
              ...
              <GridItem colSpan={{ base: 2, md: 1 }}>
                ...
                {editableField === "title" ? (
                  ...
                  <Text onDoubleClick={() => handleDoubleClick("title", data?.title)}>
                ...
                {editableField === "start" ? (
                  <>
                    <Input
                      ...
                      autoFocus
                      borderColor={
                        formik?.errors?.start && formik?.touched?.start ? "red.300" : null
                      }
                      min={
                        data?.allDay
              ...
              <GridItem colSpan={{ base: 2, md: 1 }}>
                ...
                {editableField === "end" ? (
                  ...
                  <Text onDoubleClick={() => handleDoubleClick("end", data?.end)}>
                    {data?.allDay === true
              ...
              <GridItem colSpan={{ base: 2 }}>
                ...
                {editableField === "description" ? (
                  ...
                  <Text onDoubleClick={() => handleDoubleClick("description", data?.description)}>
                ...
                {editableField === "notes" ? (
                  <>
                    <Input
                      ...
                      autoFocus
                      borderColor={
                        formik?.errors?.notes && formik?.touched?.notes ? "red.300" : null
                      }
                    />
                  ...
                  <Text onDoubleClick={() => handleDoubleClick("notes", data?.notes)}>
