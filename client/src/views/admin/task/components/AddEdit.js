            ...
            <Grid templateColumns="repeat(12, 1fr)" gap={3}>
                  ...
                  <GridItem colSpan={{ base: 12, md: 6 }}>
                    ...
                    <Flex justifyContent={"space-between"}>
                      <Select
                        ...
                        placeholder={"Assign To"}
                        borderColor={
                          errors?.assignToLead && touched?.assignToLead ? "red.300" : null
                        }
                      >
                    ...
                    <Text mb="10px" color={"red"}>
                      {" "}
                      {errors?.assignToLead && touched?.assignToLead && errors?.assignToLead}
                    </Text>
                  </GridItem>
                </>
              ) : (
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  value={
                    values?.allDay
                      ? (values?.start && dayjs(values?.start).format("YYYY-MM-DD")) || null
                      : (values?.start && dayjs(values?.start).format("YYYY-MM-DD HH:mm")) || null
                  }
                  name="start"
                  fontWeight="500"
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  value={
                    values?.allDay
                      ? (values?.end && dayjs(values?.end).format("YYYY-MM-DD")) || null
                      : (values?.end && dayjs(values?.end).format("YYYY-MM-DD HH:mm")) || null
                  }
                  name="end"
                  fontWeight="500"
              ...
              <GridItem colSpan={{ base: 12, sm: 4 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.backgroundColor && touched?.backgroundColor ? "red.300" : null
                  }
                />
                <Text mb="10px" color={"red"}>
                  {" "}
                  {errors?.backgroundColor && touched?.backgroundColor && errors?.backgroundColor}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, sm: 4 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Text mb="10px" color={"red"}>
                  {" "}
                  {errors?.borderColor && touched?.borderColor && errors?.borderColor}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, sm: 4 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
