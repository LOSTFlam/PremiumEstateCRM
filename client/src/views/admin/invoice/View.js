            ...
            <Grid gap={4}>
                  ...
                  <Box display={"flex"} justifyContent={"space-between"}>
                    ...
                    <Flex id="hide-btn">
                      <Menu>
                        ...
                        <MenuDivider />
                        <MenuList minWidth={2}>
                          {(user?.role === "superAdmin" || invoiceAccess?.create) && (
                            <MenuItem
                              onClick={() => {
                                setEdit(true);
                                setType("add");
                          ...
                          {(user?.role === "superAdmin" || invoiceAccess?.update) && (
                            <MenuItem
                              onClick={() => {
                                setEdit(true);
                                setType("edit");
                ...
                {editableField === "title" ? (
                  <>
                    <Input
                      ...
                      borderColor={
                        formik?.errors?.title && formik?.touched?.title ? "red.300" : null
                      }
                      autoFocus
                    />
                ...
                {editableField === "quoteDate" ? (
                  <>
                    <Input
                      ...
                      borderColor={
                        formik?.errors?.quoteDate && formik?.touched?.quoteDate ? "red.300" : null
                      }
                      autoFocus
                    />
                  ...
                  <Text
                    onDoubleClick={() =>
                      handleDoubleClick("quoteDate", data?.quoteDate, "Quote Date")
                    }
                  >
                    {data?.quoteDate ? dayjs(data?.quoteDate).format("YYYY-MM-DD") : " - "}
                  </Text>
                )}
              </GridItem>
              <GridItem colSpan={{ base: 2, md: 1 }}>
                ...
                {editableField === "dueDate" ? (
                  <>
                    <Input
                      ...
                      borderColor={
                        formik?.errors?.dueDate && formik?.touched?.dueDate ? "red.300" : null
                      }
                      autoFocus
                    />
                  ...
                  <Text
                    onDoubleClick={() => handleDoubleClick("dueDate", data?.dueDate, "Due Date")}
                  >
              ...
              <GridItem colSpan={{ base: 2, md: 1 }}>
                ...
                {editableField === "invoiceDate" ? (
                  ...
                  <Text
                    onDoubleClick={() =>
                      handleDoubleClick("invoiceDate", data?.invoiceDate, "Invoice Date")
                    }
                  >
                ...
                {editableField === "status" ? (
                  <>
                    <Select
                      ...
                      fontWeight="500"
                      borderColor={
                        formik?.errors?.status && formik?.touched?.status ? "red.300" : null
                      }
                    >
                  ...
                  <Text onDoubleClick={() => handleDoubleClick("status", data?.status, "Status")}>
