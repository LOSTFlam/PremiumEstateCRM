...
const AddEdit = (props) => {
  ...
  }, [setFieldValue, values?.subtotal, values?.shipping, values?.ptax]);
            ...
            <DrawerBody>
              <Grid templateColumns="repeat(12, 1fr)" gap={3}>
                ...
                <GridItem colSpan={{ base: 12, md: 6 }}>
                  ...
                  <Text mb="10px" fontSize="sm" color={"red"}>
                    {" "}
                    {errors?.quoteNumber && touched?.quoteNumber && errors?.quoteNumber}
                  </Text>
                </GridItem>
                <GridItem colSpan={{ base: 12, md: 6 }}>
                  <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                  ...
                  <Text mb="10px" fontSize="sm" color={"red"}>
                    {" "}
                    {errors?.quoteDate && touched?.quoteDate && errors?.quoteDate}
                  </Text>
                </GridItem>
                <GridItem colSpan={{ base: 12, md: 6 }}>
                  <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <GridItem colSpan={{ base: 12, md: 6 }}>
                  ...
                  <Text mb="10px" fontSize="sm" color={"red"}>
                    {" "}
                    {errors?.invoiceDate && touched?.invoiceDate && errors?.invoiceDate}
                  </Text>
                </GridItem>
                ...
                <GridItem colSpan={{ base: 12, md: 6 }}>
                  ...
                  <Input
                    ...
                    fontWeight="500"
                    borderColor={
                      errors?.shippingStreet && touched?.shippingStreet ? "red.300" : null
                    }
                  />
                  <Text mb="10px" fontSize="sm" color={"red"}>
                    {" "}
                ...
                <GridItem colSpan={{ base: 12, md: 6 }}>
                  ...
                  <Input
                    ...
                    fontWeight="500"
                    borderColor={
                      errors?.billingCountry && touched?.billingCountry ? "red.300" : null
                    }
                  />
                  <Text mb="10px" fontSize="sm" color={"red"}>
                    {" "}
                  ...
                  <div className="invoice-details">
                    <table>
                      ...
                      <tr>
                        ...
                        <td>:</td>
                        <td style={{ textAlign: "start" }}>
                          {values?.invoiceDate && moment(values?.invoiceDate).format("DD-MM-YYYY")}
                        </td>
                      </tr>
                      <tr>
