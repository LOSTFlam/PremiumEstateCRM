      ...
      <Grid gap={4}>
        ...
        <GridItem colSpan={{ base: 2, md: 1 }}>
          ...
          {editableField === "name" ? (
            ...
            <Text onDoubleClick={() => handleDoubleClick("name", data?.name, "Account Name")}>
              {data?.name ? data?.name : " - "}
            </Text>
          )}
        </GridItem>
          ...
          {editableField === "officePhone" ? (
            <>
              <Input
                ...
                borderColor={
                  formik?.errors?.officePhone && formik?.touched?.officePhone ? "red.300" : null
                }
                autoFocus
              />
              <Text mb="10px" color={"red"}>
            ...
            <Text
              onDoubleClick={() =>
                handleDoubleClick("officePhone", data?.officePhone, "Office Phone")
              }
            >
        ...
        <GridItem colSpan={{ base: 2, md: 1 }}>
          ...
          {editableField === "alternatePhone" ? (
            ...
            <Text
              onDoubleClick={() =>
                handleDoubleClick("alternatePhone", data?.alternatePhone, "Alternate Phone")
              }
            >
        ...
        <GridItem colSpan={{ base: 2, md: 1 }}>
          ...
          {editableField === "website" ? (
            <>
              ...
              <Text mb="10px" color={"red"}>
                {" "}
                {formik?.errors?.website && formik?.touched?.website && formik?.errors?.website}
              </Text>
            </>
          ) : (
            <Text onDoubleClick={() => handleDoubleClick("website", data?.website, "Website")}>
        ...
        <GridItem colSpan={{ base: 2, md: 1 }}>
          ...
          {editableField === "fax" ? (
            ...
            <Text onDoubleClick={() => handleDoubleClick("fax", data?.fax, "Fax")}>
              {data?.fax ? data?.fax : " - "}
            </Text>
          )}
        </GridItem>
          ...
          {editableField === "ownership" ? (
            <>
              <Input
                ...
                borderColor={
                  formik?.errors?.ownership && formik?.touched?.ownership ? "red.300" : null
                }
                autoFocus
              />
              <Text mb="10px" color={"red"}>
            ...
            <Text
              onDoubleClick={() => handleDoubleClick("ownership", data?.ownership, "Ownership")}
            >
          ...
          {editableField === "emailAddress" ? (
            <>
              <Input
                ...
                borderColor={
                  formik?.errors?.emailAddress && formik?.touched?.emailAddress ? "red.300" : null
                }
                autoFocus
              />
              <Text mb="10px" color={"red"}>
            ...
            <Text
              onDoubleClick={() =>
                handleDoubleClick("emailAddress", data?.emailAddress, "Email Address")
              }
            >
          ...
          {editableField === "nonPrimaryEmail" ? (
            <>
              <Input
                ...
                borderColor={
                  formik?.errors?.nonPrimaryEmail && formik?.touched?.nonPrimaryEmail
                    ? "red.300"
                    : null
                }
                autoFocus
            ...
            <Text
              onDoubleClick={() =>
                handleDoubleClick("nonPrimaryEmail", data?.nonPrimaryEmail, "Non Primary Email")
              }
            >
          ...
          {editableField === "shippingStreet2" ? (
            <>
              <Input
                ...
                borderColor={
                  formik?.errors?.shippingStreet2 && formik?.touched?.shippingStreet2
                    ? "red.300"
                    : null
                }
                autoFocus
            ...
            <Text
              onDoubleClick={() =>
                handleDoubleClick("shippingStreet2", data?.shippingStreet2, "Shipping Street2")
              }
            >
          ...
          {editableField === "billingStreet2" ? (
            <>
              <Input
                ...
                borderColor={
                  formik?.errors?.billingStreet2 && formik?.touched?.billingStreet2
                    ? "red.300"
                    : null
                }
                autoFocus
            ...
            <Text
              onDoubleClick={() =>
                handleDoubleClick("billingStreet2", data?.billingStreet2, "Billing Street2")
              }
            >
          ...
          {editableField === "shippingStreet3" ? (
            <>
              <Input
                ...
                borderColor={
                  formik?.errors?.shippingStreet3 && formik?.touched?.shippingStreet3
                    ? "red.300"
                    : null
                }
                autoFocus
            ...
            <Text
              onDoubleClick={() =>
                handleDoubleClick("shippingStreet3", data?.shippingStreet3, "Shipping Street3")
              }
            >
          ...
          {editableField === "billingStreet3" ? (
            <>
              <Input
                ...
                borderColor={
                  formik?.errors?.billingStreet3 && formik?.touched?.billingStreet3
                    ? "red.300"
                    : null
                }
                autoFocus
            ...
            <Text
              onDoubleClick={() =>
                handleDoubleClick("billingStreet3", data?.billingStreet3, "Billing Street3")
              }
            >
          ...
          {editableField === "shippingStreet4" ? (
            <>
              <Input
                ...
                borderColor={
                  formik?.errors?.shippingStreet4 && formik?.touched?.shippingStreet4
                    ? "red.300"
                    : null
                }
                autoFocus
            ...
            <Text
              onDoubleClick={() =>
                handleDoubleClick("shippingStreet4", data?.shippingStreet4, "Shipping Street4")
              }
            >
          ...
          {editableField === "billingStreet4" ? (
            <>
              <Input
                ...
                borderColor={
                  formik?.errors?.billingStreet4 && formik?.touched?.billingStreet4
                    ? "red.300"
                    : null
                }
                autoFocus
            ...
            <Text
              onDoubleClick={() =>
                handleDoubleClick("billingStreet4", data?.billingStreet4, "Billing Street4")
              }
            >
        ...
        <GridItem colSpan={{ base: 2, md: 1 }}>
          ...
          {editableField === "type" ? (
            ...
            <Text onDoubleClick={() => handleDoubleClick("type", data?.type, "Type")}>
              {data?.type ? data?.type : " - "}
            </Text>
          )}
        </GridItem>
          ...
          {editableField === "industry" ? (
            <>
              <Select
                ...
                borderColor={
                  formik?.errors?.industry && formik?.touched?.industry ? "red.300" : null
                }
              >
              ...
              <Text mb="10px" color={"red"}>
                {" "}
                {formik?.errors?.industry && formik?.touched?.industry && formik?.errors?.industry}
              </Text>
            </>
          ) : (
            <Text onDoubleClick={() => handleDoubleClick("industry", data?.industry, "Industry")}>
        ...
        <GridItem colSpan={{ base: 2, md: 1 }}>
          ...
          {editableField === "SICCode" ? (
            <>
              ...
              <Text mb="10px" color={"red"}>
                {" "}
                {formik?.errors?.SICCode && formik?.touched?.SICCode && formik?.errors?.SICCode}
              </Text>
            </>
          ) : (
            <Text onDoubleClick={() => handleDoubleClick("SICCode", data?.SICCode, "SIC Code")}>
