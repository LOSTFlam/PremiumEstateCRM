            ...
            <Grid gap={4}>
                ...
                {editableField === "website" ? (
                  <>
                    <Input
                      ...
                      borderColor={
                        formik?.errors?.website && formik?.touched?.website ? "red.300" : null
                      }
                      autoFocus
                    />
                    <Text mb="10px" color={"red"}>
                  ...
                  <Text
                    onDoubleClick={() => handleDoubleClick("website", data?.website, "Website")}
                  >
              ...
              <GridItem colSpan={{ base: 2, md: 1 }}>
                ...
                {editableField === "ownership" ? (
                  ...
                  <Text
                    onDoubleClick={() =>
                      handleDoubleClick("ownership", data?.ownership, "Ownership")
                    }
                  >
              ...
              <GridItem colSpan={{ base: 2, md: 1 }}>
                ...
                {editableField === "industry" ? (
                  ...
                  <Text
                    onDoubleClick={() => handleDoubleClick("industry", data?.industry, "Industry")}
                  >
                ...
                {editableField === "SICCode" ? (
                  <>
                    <Input
                      ...
                      borderColor={
                        formik?.errors?.SICCode && formik?.touched?.SICCode ? "red.300" : null
                      }
                      autoFocus
                    />
                    <Text mb="10px" color={"red"}>
                  ...
                  <Text
                    onDoubleClick={() => handleDoubleClick("SICCode", data?.SICCode, "SIC Code")}
                  >
