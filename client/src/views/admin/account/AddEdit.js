...
const AddEdit = (props) => {
  ...
  const initialValues = {
    ...
    shippingPostalcode:
      type === "edit" ? accountDetails?.shippingPostalcode : "",
            ...
            <Grid templateColumns="repeat(12, 1fr)" gap={3}>
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.website && touched?.website ? "red.300" : null
                  }
                />
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.ownership && touched?.ownership ? "red.300" : null
                  }
                />
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.nonPrimaryEmail && touched?.nonPrimaryEmail
                      ? "red.300"
                      : null
                  }
                />
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.nonPrimaryEmail &&
                    touched?.nonPrimaryEmail &&
                    errors?.nonPrimaryEmail}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.shippingStreet2 && touched?.shippingStreet2
                      ? "red.300"
                      : null
                  }
                />
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.shippingStreet2 &&
                    touched?.shippingStreet2 &&
                    errors?.shippingStreet2}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.billingStreet2 && touched?.billingStreet2
                      ? "red.300"
                      : null
                  }
                />
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.billingStreet2 &&
                    touched?.billingStreet2 &&
                    errors?.billingStreet2}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.shippingStreet3 && touched?.shippingStreet3
                      ? "red.300"
                      : null
                  }
                />
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.shippingStreet3 &&
                    touched?.shippingStreet3 &&
                    errors?.shippingStreet3}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.billingStreet3 && touched?.billingStreet3
                      ? "red.300"
                      : null
                  }
                />
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.billingStreet3 &&
                    touched?.billingStreet3 &&
                    errors?.billingStreet3}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.shippingStreet4 && touched?.shippingStreet4
                      ? "red.300"
                      : null
                  }
                />
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.shippingStreet4 &&
                    touched?.shippingStreet4 &&
                    errors?.shippingStreet4}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.billingStreet4 && touched?.billingStreet4
                      ? "red.300"
                      : null
                  }
                />
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Select
                  ...
                  onBlur={handleBlur}
                  mb={
                    errors?.industry && touched?.industry ? undefined : "10px"
                  }
                  fontWeight="500"
                  placeholder={"Select Industry"}
                  borderColor={
                    errors?.industry && touched?.industry ? "red.300" : null
                  }
                >
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.rating && touched?.rating ? "red.300" : null
                  }
                />
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.SICCode && touched?.SICCode ? "red.300" : null
                  }
                />
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Flex justifyContent={"space-between"}>
                  <Select
                    ...
                    onBlur={handleBlur}
                    mb={
                      errors?.memberOf && touched?.memberOf ? undefined : "10px"
                    }
                    fontWeight="500"
                    placeholder={"Member Of"}
                    borderColor={
                      errors?.memberOf && touched?.memberOf ? "red.300" : null
                    }
                  >
