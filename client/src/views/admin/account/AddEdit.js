...
import { generateValidationSchema as _generateValidationSchema } from "utils";
import _CustomForm from "utils/customForm";
...
import { fetchAccountData as _fetchAccountData } from "../../../redux/slices/accountSlice";
          ...
          <DrawerBody>
            <Grid templateColumns="repeat(12, 1fr)" gap={3}>
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.officePhone && touched?.officePhone && errors?.officePhone}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.nonPrimaryEmail && touched?.nonPrimaryEmail ? "red.300" : null
                  }
                />

                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.nonPrimaryEmail && touched?.nonPrimaryEmail && errors?.nonPrimaryEmail}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.shippingStreet && touched?.shippingStreet && errors?.shippingStreet}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.billingStreet && touched?.billingStreet && errors?.billingStreet}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.shippingStreet2 && touched?.shippingStreet2 ? "red.300" : null
                  }
                />

                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.shippingStreet2 && touched?.shippingStreet2 && errors?.shippingStreet2}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.billingStreet2 && touched?.billingStreet2 && errors?.billingStreet2}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.shippingStreet3 && touched?.shippingStreet3 ? "red.300" : null
                  }
                />

                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.shippingStreet3 && touched?.shippingStreet3 && errors?.shippingStreet3}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.billingStreet3 && touched?.billingStreet3 && errors?.billingStreet3}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.shippingStreet4 && touched?.shippingStreet4 ? "red.300" : null
                  }
                />

                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.shippingStreet4 && touched?.shippingStreet4 && errors?.shippingStreet4}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.billingStreet4 && touched?.billingStreet4 && errors?.billingStreet4}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.shippingPostalcode && touched?.shippingPostalcode ? "red.300" : null
                  }
                />
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.billingPostalcode && touched?.billingPostalcode ? "red.300" : null
                  }
                />
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.shippingCity && touched?.shippingCity && errors?.shippingCity}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.billingCity && touched?.billingCity && errors?.billingCity}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.shippingState && touched?.shippingState && errors?.shippingState}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.billingState && touched?.billingState && errors?.billingState}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.shippingCountry && touched?.shippingCountry ? "red.300" : null
                  }
                />

                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.shippingCountry && touched?.shippingCountry && errors?.shippingCountry}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.billingCountry && touched?.billingCountry && errors?.billingCountry}
                </Text>
              </GridItem>
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.annualRevenue && touched?.annualRevenue && errors?.annualRevenue}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.SICCode && touched?.SICCode && errors?.SICCode}
                </Text>
              </GridItem>
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.memberOf && touched?.memberOf && errors?.memberOf}
                </Text>
              </GridItem>

              <GridItem colSpan={{ base: 12, md: 6 }}>
                <Checkbox
                  isChecked={values?.emailOptOut}
                  onChange={handleChange}
                  name="emailOptOut"
                  lable="Email Opt Out"
                >
