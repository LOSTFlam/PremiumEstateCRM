        ...
        <Stack spacing={4}>
          <HStack justify="space-between" align={{ base: "start", md: "center" }} flexWrap="wrap">
            <Box>
              ...
              <Heading size="lg" color={headingTone}>{copy.title}</Heading>
            </Box>
            <Button colorScheme="blue" onClick={handleSave} isLoading={saving} loadingText={copy.saving}>
              {copy.save}
            </Button>
          </HStack>
            ...
            >
              <Stack spacing={5}>
                <HStack justify="space-between" align="start">
                  <Box>
                    <Heading size="md" color={headingTone}>{meta?.adminLabel || preset.slug}</Heading>
                ...
                <SimpleGrid columns={{ base: 1, md: 2 }} spacing={4}>
                  <FormControl>
                    <FormLabel color={headingTone} fontWeight="600">{copy.type}</FormLabel>
                    <Select
                      bg="white"
                      value={preset.type}
                      onChange={(event) =>
                        updatePreset(preset.slug, { type: event.target.value })
                      }
                    >
                  ...
                  <FormControl>
                    <FormLabel color={headingTone} fontWeight="600">{copy.status}</FormLabel>
                    <Select
                      bg="white"
                      value={preset.status}
                      onChange={(event) =>
                  ...
                  <FormControl>
                    <FormLabel color={headingTone} fontWeight="600">{copy.minPrice}</FormLabel>
                    <Input
                      bg="white"
                  ...
                  <FormControl>
                    <FormLabel color={headingTone} fontWeight="600">{copy.maxPrice}</FormLabel>
                    <Input
                      bg="white"
                  ...
                  <FormControl>
                    <FormLabel color={headingTone} fontWeight="600">{copy.bedrooms}</FormLabel>
                    <Select
                      bg="white"
                  ...
                  <FormControl>
                    <FormLabel color={headingTone} fontWeight="600">{copy.bathrooms}</FormLabel>
                    <Select
                      bg="white"
                  ...
                  <FormControl>
                    <FormLabel color={headingTone} fontWeight="600">{copy.verification}</FormLabel>
                    <Select
                      bg="white"
                  ...
                  <FormControl>
                    <FormLabel color={headingTone} fontWeight="600">{copy.sort}</FormLabel>
                    <Select
                      bg="white"
                      value={preset.sortBy}
                      onChange={(event) =>
                  ...
                  <FormControl gridColumn={{ base: "auto", md: "1 / -1" }}>
                    <FormLabel color={headingTone} fontWeight="600">{copy.collection}</FormLabel>
                    <Select
                      bg="white"
                    ...
                    >
                      ...
                      {featuredCollectionOptions
                        .filter(Boolean)
                        .map((slug) => {
                          const collectionMeta = getStorefrontPresetMeta(
                            slug,
                            i18n.language,
                          );
                          return (
                ...
                <SimpleGrid columns={{ base: 1, md: 2 }} spacing={4}>
                  <HStack justify="space-between" border="1px solid" borderColor={borderTone} borderRadius="16px" px={4} py={3} bg={panelBg}>
                    <Text color={headingTone} fontWeight="600">{copy.onlyWithPhotos}</Text>
                    <Switch
                      colorScheme="blue"
                  ...
                  <HStack justify="space-between" border="1px solid" borderColor={borderTone} borderRadius="16px" px={4} py={3} bg={panelBg}>
                    <Text color={headingTone} fontWeight="600">{copy.onlyRich}</Text>
                    <Switch
                      colorScheme="blue"
