...
const View = () => {
  ...
  const AddData = async () => {
    try {
      setIsLoding(true);
      let response = await putApi(`api/bank-details/edit/${params?.id}`, values);
  ...
  return (
    <>
                  ...
                  {editableField === "bank" ? (
                    <>
                      <Input
                        ...
                        borderColor={
                          formik?.errors?.bank && formik?.touched?.bank ? "red.300" : null
                        }
                        autoFocus
                      />
                      ...
                      <Text mb="10px" color={"red"}>
                        {" "}
                        {formik?.errors.bank && formik?.touched.bank && formik?.errors.bank}
                      </Text>
                    </>
                  ) : (
                    <Text onDoubleClick={() => handleDoubleClick("bank", bankDataDetails?.bank)}>
                  ...
                  {editableField === "branch" ? (
                    <>
                      <Input
                        ...
                        borderColor={
                          formik?.errors?.branch && formik?.touched?.branch ? "red.300" : null
                        }
                        autoFocus
                      />
                      ...
                      <Text mb="10px" color={"red"}>
                        {" "}
                        {formik?.errors.branch && formik?.touched.branch && formik?.errors.branch}
                      </Text>
                    </>
                  ) : (
                    <Text
                      onDoubleClick={() => handleDoubleClick("branch", bankDataDetails?.branch)}
                    >
                  ...
                  {editableField === "swiftCode" ? (
                    <>
                      <Input
                        ...
                        borderColor={
                          formik?.errors?.swiftCode && formik?.touched?.swiftCode ? "red.300" : null
                        }
                        autoFocus
                      />
      ...
      <Add isOpen={isOpen} size={"lg"} onClose={onClose} setAction={setAction} action={action} />
      <Edit
        isOpen={edit}
        size={"lg"}
