...
const View = (_props) => {
  ...
  return (
    <div>
            ...
            <Grid gap={4}>
                  ...
                  <Box display={"flex"} justifyContent={"space-between"}>
                    <Flex id="hide-btn">
                      ...
                      <Menu>
                        ...
                        <MenuDivider />
                        <MenuList minWidth={2}>
                          {(user?.role === "superAdmin" || opportunityAccess?.create) && (
                            <MenuItem
                              onClick={() => {
                                setEdit(true);
                                setType("add");
                          ...
                          {(user?.role === "superAdmin" || opportunityAccess?.update) && (
                            <MenuItem
                              onClick={() => {
                                setEdit(true);
                                setType("edit");
                ...
                {editableField === "opportunityName" ? (
                  <>
                    <Input
                      ...
                      borderColor={
                        formik?.errors?.opportunityName && formik?.touched?.opportunityName
                          ? "red.300"
                          : null
                      }
                      autoFocus
                ...
                {editableField === "leadSource" ? (
                  <>
                    <Select
                      ...
                      borderColor={
                        formik?.errors?.leadSource && formik?.touched?.leadSource ? "red.300" : null
                      }
                    >
                  ...
                  <Text
                    onDoubleClick={() =>
                      handleDoubleClick("leadSource", data?.leadSource, "Lead Source")
                    }
                  >
                ...
                {editableField === "currency" ? (
                  <>
                    <Select
                      ...
                      onBlur={handleBlur}
                      mb={
                        formik?.errors?.currency && formik?.touched?.currency ? undefined : "10px"
                      }
                      fontWeight="500"
                      placeholder={"Select Currency"}
                      borderColor={
                        formik?.errors?.currency && formik?.touched?.currency ? "red.300" : null
                      }
                    >
                  ...
                  <Text
                    onDoubleClick={() => handleDoubleClick("currency", data?.currency, "Currency")}
                  >
                ...
                {editableField === "opportunityAmount" ? (
                  <>
                    <Input
                      ...
                      autoFocus
                      borderColor={
                        formik?.errors?.opportunityAmount && formik?.touched?.opportunityAmount
                          ? "red.300"
                          : null
                      }
                    />
                ...
                {editableField === "amount" ? (
                  <>
                    <Input
                      ...
                      autoFocus
                      borderColor={
                        formik?.errors?.amount && formik?.touched?.amount ? "red.300" : null
                      }
                    />
                  ...
                  <Text onDoubleClick={() => handleDoubleClick("amount", data?.amount, "Amount")}>
                ...
                {editableField === "expectedCloseDate" ? (
                  <>
                    <Input
                      ...
                      autoFocus
                      borderColor={
                        formik?.errors?.expectedCloseDate && formik?.touched?.expectedCloseDate
                          ? "red.300"
                          : null
                      }
                    />
                ...
                {editableField === "nextStep" ? (
                  <>
                    <Input
                      ...
                      autoFocus
                      borderColor={
                        formik?.errors?.nextStep && formik?.touched?.nextStep ? "red.300" : null
                      }
                    />
                  ...
                  <Text
                    onDoubleClick={() => handleDoubleClick("nextStep", data?.nextStep, "Next Step")}
                  >
                ...
                {editableField === "salesStage" ? (
                  <>
                    <Select
                      ...
                      onBlur={handleBlur}
                      mb={
                        formik?.errors?.salesStage && formik?.touched?.salesStage
                          ? undefined
                          : "10px"
                      }
                      fontWeight="500"
                      ...
                      borderColor={
                        formik?.errors?.salesStage && formik?.touched?.salesStage ? "red.300" : null
                      }
                    >
                  ...
                  <Text
                    onDoubleClick={() =>
                      handleDoubleClick("salesStage", data?.salesStage, "Sales Stage")
                    }
                  >
              ...
              <GridItem colSpan={{ base: 2, md: 1 }}>
                ...
                {editableField === "probability" ? (
                  ...
                  <Text
                    onDoubleClick={() =>
                      handleDoubleClick("probability", data?.probability, "Probability")
                    }
                  >
      ...
      {(opportunityAccess?.update || opportunityAccess?.delete || user?.role === "superAdmin") && (
        <Card mt={3}>
          <CabinetRecordActions
            showEdit={Boolean(opportunityAccess?.update || user?.role === "superAdmin")}
            showDelete={Boolean(opportunityAccess?.delete || user?.role === "superAdmin")}
            onEdit={() => {
              setEdit(true);
              setType("edit");
            }}
