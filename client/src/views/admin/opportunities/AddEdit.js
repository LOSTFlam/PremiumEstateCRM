            ...
            <Grid templateColumns="repeat(12, 1fr)" gap={3}>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.opportunityName && touched?.opportunityName ? "red.300" : null
                  }
                />

                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.opportunityName && touched?.opportunityName && errors?.opportunityName}
                </Text>
              </GridItem>
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.opportunityAmount && touched?.opportunityAmount ? "red.300" : null
                  }
                />
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors?.expectedCloseDate && touched?.expectedCloseDate ? "red.300" : null
                  }
                />
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Text fontSize="sm" mb="10px" color={"red"}>
                  {" "}
                  {errors?.nextStep && touched?.nextStep && errors?.nextStep}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Text fontSize="sm" mb="10px" color={"red"}>
                  {" "}
                  {errors?.salesStage && touched?.salesStage && errors?.salesStage}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Text fontSize="sm" mb="10px" color={"red"}>
                  {" "}
                  {errors?.probability && touched?.probability && errors?.probability}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
