                ...
                <Tr key={item?.id || item?.no || i}>
                  ...
                  <Td>
                    ...
                    <Input
                      ...
                      max={100}
                      borderColor={
                        errors?.installments?.[i]?.title && touched?.installments?.[i]?.title
                          ? "red.300"
                          : null
                      }
                    />
                  ...
                  <Td>
                    <Input
                      ...
                      value={
                        ...
                        dayjs(values?.installments?.[i]?.startDate).format("YYYY-MM-DD")
                      }
                      fontWeight="500"
                      borderColor={
                  ...
                  <Td>
                    <Input
                      ...
                      max={100}
                      borderColor={
                        errors?.installments?.[i]?.per && touched?.installments?.[i]?.per
                          ? "red.300"
                          : null
                      }
                    />
                  ...
                  <Td>
                    <Input
                      ...
                      fontWeight="500"
                      borderColor={
                        errors?.installments?.[i]?.total && touched?.installments?.[i]?.total
                          ? "red.300"
                          : null
                      }
                    />
