  ...
  const submitStepperData = async () => {
    try {
      ...
      Object?.keys(values)?.forEach((item) => {
        ...
        formData.append(item, typeof value === "object" ? JSON.stringify(value) : value);
      });
          ...
          <DrawerBody>
            <div className="stepper">
                  ...
                  <React.Fragment key={index + 1}>
                    <div className={`step ${currentStep >= index + 1 ? "active" : ""}`}>
                      ...
                      <div className="step-info">
                        <p style={{ textAlign: "center", width: "120px" }}>{step?.description}</p>
                      </div>
                    </div>
              ...
              <div className="step-content">
                {steps?.map((step, index) => currentStep === index + 1 && step?.component)}
              </div>
            </div>
          </DrawerBody>
          <DrawerFooter>
            ...
            <Button
              ...
              onClick={steps?.length === currentStep ? handleSubmit : handleNext}
            >
