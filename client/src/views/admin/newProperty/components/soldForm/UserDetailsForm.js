          ...
          <GridItem colSpan={{ base: 12 }}>
            ...
            <Flex justifyContent="space-between">
              <Select
                ...
                mb={errors?.reletedContact && touched?.reletedContact ? undefined : "10px"}
                fontWeight="500"
                placeholder={"Releted To Contact"}
                borderColor={errors?.reletedContact && touched?.reletedContact ? "red.300" : null}
              >
            ...
            <Text mb="10px" color={"red"}>
              {errors?.reletedContact && touched?.reletedContact && errors?.reletedContact}
            </Text>
          </GridItem>
        </>
          ...
          <GridItem colSpan={{ base: 12 }}>
            ...
            <Flex justifyContent="space-between">
              <Select
                ...
                name="releetedLead"
                onChange={handleChange}
                mb={errors?.releetedLead && touched?.releetedLead ? undefined : "10px"}
                fontWeight="500"
                placeholder={"Releted To Lead"}
                borderColor={errors?.releetedLead && touched?.releetedLead ? "red.300" : null}
              >
                {leadList?.map((item) => {
                  return (
                    <option value={item?._id} key={item?._id}>
            ...
            <Text mb="10px" color={"red"}>
              {errors?.releetedLead && touched?.releetedLead && errors?.releetedLead}
            </Text>
          </GridItem>
        </>
      ) : (
