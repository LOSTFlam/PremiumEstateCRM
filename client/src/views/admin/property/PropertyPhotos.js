...
const PropertyPhotos = () => {
  ...
  const fetchProperties = async () => {
    ...
    try {
      ...
      const propertiesData = Array.isArray(response)
        ? response
    ...
    <Grid templateColumns="repeat(12, 1fr)" gap={4}>
      <GridItem colSpan={12}>
        <Flex justify="space-between" align="center" mb={4}>
          <Heading size="lg">
            {t?.("navigation.propertyPhotos") || (isRu ? "Фото объектов" : "Property Photos")}
          </Heading>
          <Input
        ...
        filteredProperties.map((property) => (
          <GridItem key={property._id} colSpan={{ base: 12, md: 6, lg: 4 }}>
            <Card
              ...
              cursor="pointer"
              onClick={() =>
                setSelectedProperty(selectedProperty?._id === property._id ? null : property)
              }
              ...
              <Flex direction="column" gap={3}>
                ...
                <Flex justify="space-between" align="center">
                  <Text fontSize="sm" color="green.600" fontWeight="bold">
                    ...
                    {isRu ? "фото" : property.propertyPhotos?.length === 1 ? "photo" : "photos"}
                  </Text>
              ...
              <Text color="gray.500" fontSize="lg">
                {searchQuery
                  ? isRu
                    ...
                    : "No properties found"
                  : isRu
                    ? "Объектов с фото пока нет"
                    : "No properties with photos yet"}
              </Text>
