...
const AddEdit = (props) => {
  ...
  }, [values?.subtotal, values?.shipping, values?.ptax, setFieldValue]);
            ...
            <Grid templateColumns="repeat(12, 1fr)" gap={3}>
              ...
              {(user?.role === "superAdmin" || opportunityAccess?.view) && (
                <GridItem colSpan={{ base: 12, md: 6 }}>
                  ...
                  <Text mb="10px" fontSize="sm" color={"red"}>
                    {" "}
                    {errors?.oppotunity && touched?.oppotunity && errors?.oppotunity}
                  </Text>
                </GridItem>
              )}
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.quoteStage && touched?.quoteStage && errors?.quoteStage}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.validUntil && touched?.validUntil && errors?.validUntil}
                </Text>
              </GridItem>
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.paymentTerms && touched?.paymentTerms && errors?.paymentTerms}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12, md: 6 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.approvalStatus && touched?.approvalStatus && errors?.approvalStatus}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.approvalIssues && touched?.approvalIssues && errors?.approvalIssues}
                </Text>
              </GridItem>
              <GridItem colSpan={{ base: 12 }}>
                <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
                      ...
                      {values?.items?.length > 0 &&
                        values?.items?.map((item, index) => (
                          <Tr key={item?.id}>
                            ...
                            <Td>
                              <FormControl>
                                <Input
                                  ...
                                  onChange={(e) =>
                                    handleChangeCalculation(index, "productName", e?.target?.value)
                                  }
                                  size="sm"
                                />
                              </FormControl>
                            ...
                            <Td>
                              <FormControl>
                                <Input
                                  ...
                                  value={item?.qty}
                                  onChange={(e) =>
                                    handleChangeCalculation(index, "qty", Number(e?.target?.value))
                                  }
                                  size="sm"
                                />
                              </FormControl>
                            ...
                            <Td>
                              <FormControl>
                                <Input
                                  ...
                                  value={item?.rate}
                                  onChange={(e) =>
                                    handleChangeCalculation(index, "rate", Number(e?.target?.value))
                                  }
                                  size="sm"
                                />
                              </FormControl>
                            ...
                            <Td>
                              <FormControl>
                                <Input type="number" value={item?.amount} readOnly size="sm" />
                              </FormControl>
                            </Td>
                          </Tr>
                        ))}
              ...
              <GridItem colSpan={{ base: 12, md: 10 }}>
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.shippingTax && touched?.shippingTax && errors?.shippingTax}
                </Text>
              </GridItem>
              ...
              <GridItem colSpan={{ base: 12 }}>
                ...
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
                  {errors?.grandTotal && touched?.grandTotal && errors?.grandTotal}
                </Text>
              </GridItem>
            </Grid>
          </DrawerBody>
