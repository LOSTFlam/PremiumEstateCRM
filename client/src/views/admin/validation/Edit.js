...
const Edit = (props) => {
  ...
  const initialValues = {
    ...
    validations: [
      ...
      {
        types: editdata?.validations
          ? editdata?.validations[4]?.formikType
            ? true
            : false
          : "",
        formikType: editdata?.validations
          ? editdata?.validations[4]?.formikType
          : "",
  ...
  const formik = useFormik({
    ...
    validate: (values) => {
      ...
      if (
        values?.validations &&
        values?.validations[0]?.require &&
        !values?.validations[0]?.message
      ) {
      ...
      if (
        values?.validations &&
        values?.validations[1]?.min &&
        !values?.validations[1]?.value
      ) {
        errors.validations = errors?.validations || [];
      ...
      if (
        values?.validations &&
        values?.validations[2]?.max &&
        !values?.validations[2]?.value
      ) {
        errors.validations = errors?.validations || [];
      ...
      if (
        values?.validations &&
        values?.validations[3]?.match &&
        !values?.validations[3]?.value &&
        !values?.validations[3]?.message
      ) {
        errors.validations = errors?.validations || [];
      ...
      if (
        values?.validations &&
        values?.validations[4]?.types &&
        !values?.validations[4]?.formikType
      ) {
        errors.validations = errors?.validations || [];
              ...
              <Grid templateColumns="repeat(12, 1fr)" gap={3}>
                ...
                <GridItem colSpan={{ base: 12, md: 8 }}>
                  ...
                  <Input
                    ...
                    borderColor={
                      errors?.validations &&
                      touched?.validations &&
                      errors?.validations[0]?.message &&
                      touched?.validations[0]?.message
                        ? "red.300"
                        : null
                    }
                  />
                ...
                <GridItem colSpan={{ base: 12, sm: 6, md: 4 }} mt={8}>
                  <Flex>
                    <Checkbox
                      colorScheme="brandScheme"
                      isChecked={values?.validations[1]?.min}
                      onChange={(e) => {
                        const isChecked = e?.target?.checked;
                ...
                <GridItem colSpan={{ base: 12, sm: 6, md: 4 }}>
                  ...
                  <Input
                    ...
                    borderColor={
                      errors?.validations &&
                      touched?.validations &&
                      errors?.validations[1]?.value &&
                      touched?.validations[1]?.value
                        ? "red.300"
                        : null
                    }
                  />
                ...
                <GridItem colSpan={{ base: 12, sm: 6, md: 4 }} mt={8}>
                  <Flex>
                    <Checkbox
                      colorScheme="brandScheme"
                      isChecked={values?.validations[1]?.max}
                      onChange={(e) => {
                        const isChecked = e?.target?.checked;
                ...
                <GridItem colSpan={{ base: 12, sm: 6, md: 4 }}>
                  ...
                  <Input
                    ...
                    borderColor={
                      errors?.validations &&
                      touched?.validations &&
                      errors?.validations[2]?.value &&
                      touched?.validations[2]?.value
                        ? "red.300"
                        : null
                    }
                  />
                ...
                <GridItem colSpan={{ base: 12, sm: 6, md: 4 }} mt={8}>
                  <Flex>
                    <Checkbox
                      colorScheme="brandScheme"
                      isChecked={values?.validations[3]?.match}
                      me="10px"
                      name={`validations[${3}].match`}
                      onChange={(e) => {
                        const isChecked = e?.target?.checked;
                ...
                <GridItem colSpan={{ base: 12, sm: 6, md: 4 }}>
                  ...
                  <Input
                    ...
                    borderColor={
                      errors?.validations &&
                      touched?.validations &&
                      errors?.validations[3]?.value &&
                      touched?.validations[3]?.value
                        ? "red.300"
                        : null
                    }
                  />
                ...
                <GridItem colSpan={{ base: 12, sm: 6, md: 4 }}>
                  ...
                  <Input
                    ...
                    borderColor={
                      errors?.validations &&
                      touched?.validations &&
                      errors?.validations[3]?.message &&
                      touched?.validations[3]?.message
                        ? "red.300"
                        : null
                    }
                  />
                ...
                <GridItem colSpan={{ base: 12, sm: 6, md: 4 }} mt={8}>
                  <Flex>
                    <Checkbox
                      colorScheme="brandScheme"
                      isChecked={values?.validations[4]?.types}
                      name={`validations[${4}].types`}
                      me="10px"
                      onChange={(e) => {
                        const isChecked = e?.target?.checked;
                ...
                <GridItem colSpan={{ base: 12, sm: 6, md: 4 }}>
                  ...
                  <Select
                    ...
                    borderColor={
                      errors?.validations &&
                      touched?.validations &&
                      errors?.validations[4]?.formikType &&
                      touched?.validations[4]?.formikType
                        ? "red.300"
                        : null
                    }
                  >
