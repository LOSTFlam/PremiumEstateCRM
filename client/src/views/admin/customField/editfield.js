...
const EditField = (props) => {
  const { moduleId, filed: _filed, updateFiled, headingsData, validations } = props;
  ...
  const initialValues = {
    ...
    validate:
      updateFiled?.validation &&
      (updateFiled?.validation[0]?.require ||
        updateFiled?.validation[1]?.min ||
        updateFiled?.validation[2]?.max ||
        updateFiled?.validation[3]?.match ||
        updateFiled?.validation[4]?.formikType)
        ? true
        : false,
  ...
  const _underHeadingSchema = yup.object({
  ...
  const formik = useFormik({
    ...
    validate: (values) => {
      ...
      if (
        values?.validation &&
        (values?.validation[1]?.min || values?.type === "range") &&
        values?.validation[1]?.value === ""
      ) {
      ...
      if (
        values?.validation &&
        (values?.validation[2]?.max || values?.type === "range") &&
        values?.validation[2]?.value === ""
      ) {
        errors.validation = errors?.validation || [];
      ...
      if (
        values?.validation &&
        values?.validation[4]?.types &&
        !values?.validation[4]?.formikType
      ) {
        errors.validation = errors?.validation || [];
  ...
  const EditData = async () => {
    try {
      ...
      let response = await putApi(
        `api/custom-field/change-single-field/${updateFiled?._id}`,
        editDataPayload
      );
            ...
            <>
              <Grid templateColumns="repeat(12, 1fr)" gap={3}>
                ...
                <GridItem colSpan={{ base: 12, sm: 6, md: 4 }}>
                  ...
                  <Text mb="10px" color={"red"}>
                    {" "}
                    {errors?.belongsTo && touched?.belongsTo && errors?.belongsTo}
                  </Text>
                </GridItem>
                ...
                {values?.type === "radio" || values?.type === "select" ? (
                  <>
                    <GridItem
                      ...
                      borderBottom={"1px solid rgba(128, 128, 128, 0.705)"}
                    >
                      <Flex justifyContent={"space-between"} alignItems={"center"} mb={"8px"}>
                        <Heading as="h1" size="md">
                          Option
                        </Heading>
                        <Button size="sm" variant="brand" onClick={() => handleAddOption()}>
                          Add
                        </Button>
                      </Flex>
                    </GridItem>
                ...
                >
                  <Flex alignItems="center" justifyContent={"space-between"} mb={"8px"}>
                    ...
                    <Flex>
                      {validations?.length > 0 && (
                        <Select
                          ...
                          onChange={(e) => {
                            setValidationType(e?.target?.value);
                            if (e?.target?.value) {
                              const validationData = validations?.filter(
                                (item) => item?._id === e?.target?.value
                              );
                              const filterData =
                                validationData?.length > 0
                                  ? validationData[0]?.validations
                                  : values?.validation;
                              setFieldValue("validation", filterData);
                              ...
                              setFieldValue("validation", [
                                {
                                  require: updateFiled?.validation
                                    ? updateFiled?.validation[0]?.require
                                    : "",
                                  message: updateFiled?.validation
                                    ? updateFiled?.validation[0]?.message
                                    : "",
                                },
                                {
                                  min: updateFiled?.validation
                                    ? updateFiled?.validation[1]?.min
                                    : "",
                                  value: updateFiled?.validation
                                    ? updateFiled?.validation[1]?.value
                                    : "",
                                  message: updateFiled?.validation
                                    ? updateFiled?.validation[1]?.message
                                    : "",
                                },
                                {
                                  max: updateFiled?.validation
                                    ? updateFiled?.validation[2]?.max
                                    : "",
                                  value: updateFiled?.validation
                                    ? updateFiled?.validation[2]?.value
                                    : "",
                                  message: updateFiled?.validation
                                    ? updateFiled?.validation[2]?.message
                                    : "",
                                },
                                {
                                  match: updateFiled?.validation
                                    ? updateFiled?.validation[3]?.match
                                    : "",
                                  value: updateFiled?.validation
                                    ? updateFiled?.validation[3]?.value
                                    : "",
                                  message: updateFiled?.validation
                                    ? updateFiled?.validation[3]?.message
                                    : "",
                                },
                                {
                                  types: updateFiled?.validation
                                    ? updateFiled?.validation[4]?.formikType
                                      ...
                                      : false
                                    : "",
                                  formikType: updateFiled?.validation
                                    ? updateFiled?.validation[4]?.formikType
                                    : "",
                                  message: updateFiled?.validation
                                    ? updateFiled?.validation[4]?.message
                                    : "",
                                },
                              ]);
                            }
                      ...
                      <Checkbox
                        isChecked={values?.type === "range" || values?.validate ? true : false}
                        colorScheme="brandScheme"
                        me="10px"
                        onChange={(e) => {
                          setFieldValue(`validate`, e?.target?.checked);
                        }}
                      />
                    </Flex>
                  </Flex>
                  ...
                  <>
                    ...
                    <GridItem colSpan={{ base: 12, md: 8 }}>
                      ...
                      <Input
                        ...
                        onBlur={handleBlur}
                        value={
                          values?.validation[0]?.require === true
                            ? values?.validation[0]?.message
                            : ""
                        }
                    ...
                    {!(
                      ...
                      <>
                            ...
                            <Checkbox
                              ...
                              onChange={(e) => {
                                ...
                                setFieldValue(
                                  ...
                                  isChecked || values?.type === "range"
                                    ? values?.validation[1]?.message
                                    : ""
                                );
                                setFieldValue(
                                  "validation[1].value",
                        ...
                        <GridItem colSpan={{ base: 12, sm: 6, md: 4 }}>
                          ...
                          >
                            Value
                            {values?.validation[1]?.min === true || values?.type === "range" ? (
                              <Text color={"red"}>*</Text>
                            ) : (
                              ""
                            )}
                          ...
                          <Input
                            ...
                            borderColor={
                              ...
                              errors?.validation &&
                              touched?.validation &&
                              errors?.validation[1]?.value &&
                              touched?.validation[1]?.value
                                ? "red.300"
                                : null
                            }
                          />
                        ...
                        <GridItem colSpan={{ base: 12, sm: 6, md: 4 }}>
                          ...
                          >
                            Value
                            {values?.validation[2]?.max === true || values?.type === "range" ? (
                              <Text color={"red"}>*</Text>
                            ) : (
                              ""
                            )}
                          ...
                          <Input
                            ...
                            borderColor={
                              ...
                              errors?.validation &&
                              touched?.validation &&
                              errors?.validation[2]?.value &&
                              touched?.validation[2]?.value
                                ? "red.300"
                                : null
                            }
                          />
                        ...
                        <GridItem colSpan={{ base: 12, sm: 6, md: 4 }} mt={8}>
                          <Flex>
                            <Checkbox
                              colorScheme="brandScheme"
                              isChecked={values?.validation[3]?.match}
                              me="10px"
                              name={`validation[${3}].match`}
                              onChange={(e) => {
                                const isChecked = e?.target?.checked;
                        ...
                        <GridItem colSpan={{ base: 12, sm: 6, md: 4 }}>
                          ...
                          <Input
                            ...
                            borderColor={
                              ...
                              errors?.validation &&
                              touched?.validation &&
                              errors?.validation[3]?.value &&
                              touched?.validation[3]?.value
                                ? "red.300"
                                : null
                            }
                          />
                        ...
                        <GridItem colSpan={{ base: 12, sm: 6, md: 4 }}>
                          ...
                          <Input
                            ...
                            borderColor={
                              ...
                              errors?.validation &&
                              touched?.validation &&
                              errors?.validation[3]?.message &&
                              touched?.validation[3]?.message
                                ? "red.300"
                                : null
                            }
                          />
                        ...
                        <GridItem colSpan={{ base: 12, sm: 6, md: 4 }} mt={8}>
                          <Flex>
                            <Checkbox
                              colorScheme="brandScheme"
                              disabled={values?.type === "date" ? true : false}
                              isChecked={values?.validation[4]?.types}
                              name={`validation[${4}].types`}
                              me="10px"
                              onChange={(e) => {
                                const isChecked = e?.target?.checked;
                        ...
                        <GridItem colSpan={{ base: 12, sm: 6, md: 4 }}>
                          ...
                          <Select
                            ...
                            borderColor={
                              ...
                              errors?.validation &&
                              touched?.validation &&
                              errors?.validation[4]?.formikType &&
                              touched?.validation[4]?.formikType
                                ? "red.300"
                                : null
                            }
                          >
