...
const CustomField = () => {
  ...
  const handleHeadingsDragEnd = async (result) => {
    ...
    const _response = await putApi(`api/custom-field/change-headings/${moduleId}`, newData);
    fetchData();
  };
  ...
  const fetchData = async () => {
    ...
    if (moduleName) {
      ...
      const filterData = response?.data[0]?.fields?.filter(
        (field) => (headingId ? headingId : field?.belongsTo) === field?.belongsTo
      );
                              ...
                              <div ref={provided?.innerRef} {...provided.draggableProps}>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    {!item?.fixed && (
                                      <Checkbox
                                        ...
                                        isChecked={selectedHeadings?.includes(item?._id)}
                                        onChange={(event) =>
                                          handleHeadigsCheckboxChange(event, item?._id)
                                        }
                                        me="10px"
                                      />
                                    )}
                                  ...
                                  <span className="EditDelete">
                                    ...
                                    {item?.fixed ? (
                                      <Button size="sm" variant="outline" me={2} color={"gray"}>
                                        <DeleteIcon />
                                      </Button>
                                    ) : (
                                      <Button
                                        ...
                                        color={"red"}
                                        onClick={() => {
                                          handleOpenDeleteModel(item?._id, "one");
                                        }}
                                      >
                                        <DeleteIcon />
                                      </Button>
                                        ...
                                        <span className="EditDelete">
                                          ...
                                          {item?.fixed ? (
                                            ...
                                            <Button
                                              ...
                                              color={"red"}
                                              onClick={() => {
                                                handleOpenDeleteMany(item?._id, "one");
                                              }}
                                            >
                                              <DeleteIcon />
                                            </Button>
