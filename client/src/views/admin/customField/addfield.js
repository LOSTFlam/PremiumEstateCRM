...
const Addfield = (props) => {
  const { moduleId, filed: _filed, headingsData, validations } = props;
  ...
  const fetchAddData = async () => {
    try {
      ...
      toast.error(error?.response?.data?.message || "Unable to add field.");
    }
  };
                  ...
                  <Select
                    ...
                    onChange={(e) => {
                      ...
                      setFieldValue(
                        ...
                        e.target.value === "date" ? "date" : ""
                      );
                      setFieldValue(
                        `validation[${4}].types`,
                        e.target.value === "date" ? true : false
                      );
                    }}
                    fontWeight="500"
                  ...
                  <Flex alignItems="center" justifyContent={"space-between"} mb={"8px"}>
                    ...
                    <Flex>
                      ...
                      <Checkbox
                        ...
                        onChange={(e) => setFieldValue(`validate`, e.target.checked)}
                      />
                    </Flex>
                  </Flex>
                </GridItem>
                        ...
                        <GridItem colSpan={{ base: 12, sm: 6, md: 4 }} mt={8}>
                          <Flex>
                            <Checkbox
                              ...
                              me="10px"
                              isChecked={
                                values?.validation[2].max || values?.type === "range" ? true : false
                              }
