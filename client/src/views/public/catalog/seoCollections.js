...
const copy = {
  ru: {
    verified: {
      ...
      description: "Объекты с полными карточками, документами, фото и подтверждённой структурой.",
    ...
    "family-homes": {
      ...
      description: "Просторные дома от 3 спален, участки и быстрый контакт с агентом.",
    ...
    "city-apartments": {
      ...
      description: "Квартиры для городской жизни с быстрым контактом брокера и удобным просмотром.",
