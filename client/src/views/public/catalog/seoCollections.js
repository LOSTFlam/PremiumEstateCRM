...
const copy = {
  ru: {
    verified: {
      ...
      faq: [
        { q: "Что считается проверенным объектом?", a: "Объект имеет расширенное описание, цену, адрес, фото, документы и агентскую карточку либо вручную подтвержденный статус в системе." },
        { q: "Можно ли оставлять заявку без регистрации?", a: "Да. Форма на странице подборки и в карточке объекта сразу создает обращение в системе." },
      ],
    },
    "family-homes": {
      badge: "Семейный формат",
      title: "Семейные дома и виллы",
      description: "Отдельная поисковая страница под большой семейный запрос: просторные дома, несколько спален, участки и удобный контакт с агентом.",
      ...
      faq: [
        ...
        { q: "Можно ли использовать подборку как посадочную страницу для рекламы?", a: "Да. Страница имеет отдельный заголовок, описание и текстовые поисковые блоки." },
      ],
    },
    "city-apartments": {
      ...
      faq: [
        { q: "Почему отдельная поисковая страница лучше простого фильтра?", a: "У нее своя структура контента, заголовки, описание и текстовые блоки под поисковый интент." },
    ...
    "investment-plots": {
      ...
      description: "Подборка участков для девелопмента и инвестиций с понятным сценарием обращения и поисковым текстом под земельный спрос.",
      heroPoints: ["Под инвестиции", "Под строительство", "Заявка агенту в 1 форме"],
      faq: [
        { q: "Подходит ли страница для земельного трафика?", a: "Да. Подборка собирает релевантные участки и дает отдельный поисковый посадочный экран." },
        { q: "Можно ли оставить запрос на подбор?", a: "Да. Форма отправляет обращение с привязкой к объекту и агенту." },
      ],
    },
    "premium-commercial": {
      badge: "Коммерческий премиум",
      title: "Премиальная коммерческая недвижимость",
      description: "Отдельная витрина под офисы и коммерческие пространства с сильными сигналами доверия и быстрой заявкой брокеру.",
      heroPoints: ["Офисы и шоурумы", "Полные карточки", "Быстрая заявка брокеру"],
      faq: [
        { q: "Что делает коммерческую подборку сильнее?", a: "Отдельная поисковая страница, быстрый доступ к документам и агентский контакт без лишних шагов." },
        { q: "Можно ли продвигать подборку отдельно от общего каталога?", a: "Да. У страницы собственные мета-теги и понятный коммерческий сценарий." },
      ],
    },
  },
  en: {
    ...
    "investment-plots": {
      ...
      faq: [
        ...
        { q: "Can visitors request a curated shortlist?", a: "Yes. The form creates a CRM lead linked to the listing and the responsible agent." },
      ],
    },
    "premium-commercial": {
      ...
      faq: [
        ...
        { q: "Can it be promoted separately from the main catalog?", a: "Yes. The page has its own meta tags and clear commercial-intent messaging." },
      ],
    },
  },
};
