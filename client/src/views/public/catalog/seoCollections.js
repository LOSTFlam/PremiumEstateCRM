...
const copy = {
  ru: {
    verified: {
      ...
      description:
        "Подборка объектов с лучшим уровнем заполнения карточки, документами, фото и подтверждённой структурой объявления.",
    ...
    "family-homes": {
      ...
      description:
        "Отдельная поисковая страница под большой семейный запрос: просторные дома, несколько спален, участки и удобный контакт с агентом.",
    ...
    "city-apartments": {
      ...
      description:
        "Подборка квартир с акцентом на городскую жизнь, быструю коммуникацию с брокером и удобный сценарий просмотра карточек.",
    ...
    "premium-commercial": {
      ...
      description:
        "Отдельная витрина под офисы и коммерческие пространства с сильными сигналами доверия и быстрой заявкой брокеру.",
