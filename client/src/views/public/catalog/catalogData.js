...
export const placeholderImage = "https://placehold.co/800x600/1a202c/ffffff?text=%D0%9E%D0%B1%D1%8A%D0%B5%D0%BA%D1%82";
...
const isRu = (language = runtimeLanguage()) =>
  String(language).toLowerCase().startsWith("ru");

const runtimeLocale = (language = runtimeLanguage()) =>
  isRu(language) ? "ru-RU" : "en-US";
...
export const samplePublicProperties = [
  {
    ...
    marketingDescription: "Современная семейная вилла с панорамным остеклением, приватным участком и террасой для отдыха.",
    propertyDescription: "Дом рассчитан на постоянное проживание: здесь есть кабинет, гостевой блок, хозяйственная зона и просторная гостиная с видом на сад.",
  ...
  },
  {
    ...
    marketingDescription: "Дизайнерские апартаменты с видом на центр Москвы, приватным холлом и консьерж-сервисом.",
    propertyDescription: "Угловой лот с кухней-гостиной, мастер-спальней, гостевой комнатой, встроенными системами хранения и продуманным сценарием освещения.",
    ...
    heatingAndCoolingSystems: "Центральная мультизональная климатическая система, теплый пол в ванных комнатах",
  ...
  },
  {
    ...
    marketingDescription: "Видовой участок под частный дом или арендный проект рядом с водой и готовым подъездом.",
    propertyDescription: "Ровный земельный лот с подведенными точками подключения, лесной линией и спокойным жилым окружением.",
    communityAmenities: "Доступ к воде, закрытый въезд, веломаршруты, курортная инфраструктура рядом",
    ...
    unitType: [
      { _id: "fa-1", name: "Сценарий частной застройки", sqm: "1800 м²", price: "92000" },
    ],
  },
  {
    ...
    marketingDescription: "Современный таунхаус с террасой на крыше и прямым выходом к прогулочной линии у воды.",
    propertyDescription: "Трехуровневый дом с открытой общественной зоной, приватным патио, гардеробными и отдельной комнатой для кино.",
    ...
    unitType: [
      { _id: "ht-1", name: "Полный таунхаус", sqm: "236 м²", price: "680000" },
    ],
  },
  {
    ...
    marketingDescription: "Компактные городские апартаменты для жизни или аренды рядом с парками и ресторанами центра.",
    propertyDescription: "Планировка включает кухню-гостиную, мастер-спальню, гибкую вторую комнату и большие окна с тихой ориентацией во двор.",
  ...
  },
  {
    ...
    marketingDescription: "Земельный участок внутри нового поселка с центральными коммуникациями и быстрой логистикой до города.",
    propertyDescription: "Ровный прямоугольный лот подготовлен под малоэтажную застройку, имеет точки подключения газа и электричества и готовую дорожную сеть.",
    ...
    unitType: [
      { _id: "me-1", name: "Участок под дом", sqm: "1200 м²", price: "64000" },
    ],
  },
  {
    ...
    marketingDescription: "Гибкий офисный этаж для штаб-квартиры, шоурума или клиентского пространства в деловой локации.",
    propertyDescription: "Помещение включает открытую рабочую зону, кабинеты партнеров, переговорные, ресепшен, кухню, серверную и панорамное остекление.",
    ...
    unitType: [
      { _id: "ao-1", name: "Целый офисный этаж", sqm: "310 м²", price: "510000" },
    ],
  },
  {
    ...
    marketingDescription: "Семейная квартира с видом на зеленый внутренний сад и спокойным малоэтажным окружением.",
    propertyDescription: "Тихая резиденция с просторной дневной зоной, хозяйственной комнатой, семейным хранением, мастер-спальней и выходом к благоустроенному подиуму.",
    ...
    unitType: [
      { _id: "gc-1", name: "Квартира с 3 спальнями", sqm: "102 м²", price: "287000" },
    ],
  },
  {
    ...
    marketingDescription: "Большая семейная резиденция с оздоровительным этажом, открытым бассейном и отдельным гостевым павильоном.",
    propertyDescription: "Планировка включает двухсветный салон, кинотеатр, семейную кухню, три гардеробные, рабочее крыло и ландшафтный участок с взрослыми кедрами.",
    ...
    unitType: [
      { _id: "cc-1", name: "Основная резиденция", sqm: "510 м²", price: "1490000" },
    ],
  },
  {
    ...
    marketingDescription: "Крупный инвестиционный участок под таунхаусы, коммерцию у дороги или смешанный формат застройки.",
    propertyDescription: "Площадка расположена рядом с новым транспортным коридором, имеет удобный инженерный доступ и подходит для поэтапного строительства.",
    communityAmenities: "Транспортный узел, торговый кластер, инженерный коридор, логистический доступ",
    appliancesIncluded: "Не применимо",
    ...
    unitType: [
      { _id: "ch-1", name: "Девелоперский лот", sqm: "3200 м²", price: "185000" },
    ],
  },
  {
    ...
    marketingDescription: "Торговый блок с высокой видимостью и двойным фасадом под шоурум, клинику или флагманский магазин.",
    propertyDescription: "Планировка включает открытый торговый зал, внутренний офис, склад, служебные комнаты и отдельный доступ для поставок.",
    communityAmenities: "Метро рядом, крупный торговый центр, банковский кластер, гастрономическое пространство",
    ...
    unitType: [
      { _id: "ng-1", name: "Флагманский торговый блок", sqm: "420 м²", price: "640000" },
    ],
  },
  {
    ...
    marketingDescription: "Премиальный офисный этаж для юридических, финансовых и команд по частному капиталу, которым важен статус адреса.",
    propertyDescription: "Включает ресепшен, кабинеты партнеров, большую переговорную, клиентскую зону отдыха, архив, защищенную серверную и приватную террасу с видом на панораму города.",
...
export const normalizeStatus = (status, t) => {
  if (!status) return t?.("modules.dashboardHome.statusAvailable") || (isRu() ? "Доступно" : "Available");
