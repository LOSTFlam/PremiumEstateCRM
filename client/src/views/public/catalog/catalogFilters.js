...
export const matchesPublicCatalogFilters = (property, filters = {}) => {
  ...
  const search = String(normalizedFilters.search || "").trim().toLowerCase();
  ...
  return (
    ...
    (normalizedFilters.bedrooms === "all" ||
      bedrooms >= Number(normalizedFilters.bedrooms)) &&
    (normalizedFilters.bathrooms === "all" ||
      bathrooms >= Number(normalizedFilters.bathrooms)) &&
