...
export default function LeadCaptureCard({ property, agent, collectionSlug = "", title, subtitle }) {
      ...
      <Stack spacing={5}>
        ...
        {resolvedAgent && (
          ...
          >
            <Stack spacing={2}>
              ...
              {resolvedAgent?.email ? (
                <Text color="whiteAlpha.740">{resolvedAgent.email}</Text>
              ) : null}
              {resolvedAgent?.phoneNumber ? (
                <Text color="whiteAlpha.740">{resolvedAgent.phoneNumber}</Text>
              ) : null}
        ...
        <FormControl>
          ...
          <Select
            ...
            onChange={(event) =>
              setValues((current) => ({ ...current, preferredContact: event.target.value }))
            }
            bg="white"
