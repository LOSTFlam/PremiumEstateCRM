...
import { useMousePosition as _useMousePosition } from "hooks/useMousePosition";
...
export const PremiumCard = ({
  ...
  return (
    ...
    >
      ...
      {shimmer && <div className="absolute inset-0 animated-gradient-border pointer-events-none" />}
      ...
      <div
        className="absolute top-4 right-4 w-2 h-2 rounded-full bg-gradient-to-br from-brand-300 to-brand-500 animate-pulse-soft"
        style={{ animationDelay: "0.5s" }}
      />

      <div
        className="absolute bottom-4 left-4 w-2 h-2 rounded-full bg-gradient-to-br from-brand-300 to-brand-500 animate-pulse-soft"
        style={{ animationDelay: "1s" }}
      />

      <div
        className="absolute bottom-4 right-4 w-2 h-2 rounded-full bg-gradient-to-br from-brand-300 to-brand-500 animate-pulse-soft"
