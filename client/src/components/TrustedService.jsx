...
const statsData = [
  {
    value: "15+",
    label: "publicListing.yearsExperience",
    description: "publicListing.yearsExperienceText",
  },
  {
    value: "5000+",
    label: "publicListing.propertiesSold",
    description: "publicListing.propertiesSoldText",
  },
  {
    value: "98%",
    label: "publicListing.clientSatisfaction",
    description: "publicListing.clientSatisfactionText",
  },
          ...
          <SimpleGrid columns={{ base: 1, md: 3 }} spacing={6}>
            <GlassCard p={6}>
              <Stack spacing={3}>
                ...
                <Text color={descColor}>{t("publicListing.transparentText")}</Text>
              </Stack>
            </GlassCard>
            ...
            <GlassCard p={6}>
              <Stack spacing={3}>
                ...
                <Text color={descColor}>{t("publicListing.secureTransactionsText")}</Text>
              </Stack>
            </GlassCard>
            ...
            <GlassCard p={6}>
              <Stack spacing={3}>
                ...
                <Text color={descColor}>{t("publicListing.provenTrackText")}</Text>
              </Stack>
            </GlassCard>
          </SimpleGrid>
        </Stack>
