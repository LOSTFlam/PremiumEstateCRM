...
import { FiSearch, FiHome, FiUsers, FiSettings, FiBarChart2, FiFileText, FiCalendar, FiHelpCircle } from "react-icons/fi";
...
const COMMANDS = [
  ...
  { id: "properties", label: "Properties", shortcut: "P", icon: FiFileText, path: "/admin/properties" },
  { id: "analytics", label: "Analytics", shortcut: "A", icon: FiBarChart2, path: "/admin/analytics" },
