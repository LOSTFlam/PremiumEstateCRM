...
import _PropertyModel from "components/commonTableModel/PropertyModel";
import Spinner from "components/spinner/Spinner";
import dayjs from "dayjs";
import { useFormik } from "formik";
import { useEffect, useState } from "react";
import { LiaMousePointerSolid } from "react-icons/lia";
import { phoneCallSchema as _phoneCallSchema } from "schema/phoneCallSchema";
        ...
        <ModalBody>
          ...
          <Grid templateColumns="repeat(12, 1fr)" gap={3}>
                  ...
                  <GridItem colSpan={{ base: 12, md: 6 }}>
                    ...
                    <Flex justifyContent={"space-between"}>
                      <Select
                        ...
                        mb={
                          errors?.createByContact && touched?.createByContact ? undefined : "10px"
                        }
                        fontWeight="500"
                        placeholder={"Assign To"}
                        borderColor={
                          errors?.createByContact && touched?.createByContact ? "red.300" : null
                        }
                      >
                  ...
                  <GridItem colSpan={{ base: 12, md: 6 }}>
                    ...
                    <Flex justifyContent={"space-between"}>
                      <Select
                        ...
                        placeholder={"Assign To"}
                        borderColor={
                          errors?.createByLead && touched?.createByLead ? "red.300" : null
                        }
                      >
                    ...
                    <Text mb="10px" fontSize="sm" color={"red"}>
                      {" "}
                      {errors?.createByLead && touched?.createByLead && errors?.createByLead}
                    </Text>
                  </GridItem>
                </>
              ) : (
              ...
              <Flex alignItems={"end"} justifyContent={"space-between"}>
                <Text w={"100%"}>
                  <CUIAutoComplete
                    ...
                    borderColor={errors?.property && touched?.property ? "red.300" : null}
                  />
                </Text>
                <IconButton
                  mb={6}
            ...
            <GridItem colSpan={{ base: 12, md: 6 }}>
              ...
              <Text mb="10px" fontSize="sm" color={"red"}>
                {" "}
                {errors?.callDuration && touched?.callDuration && errors?.callDuration}
              </Text>
            </GridItem>
            <GridItem colSpan={{ base: 12 }}>
              <FormLabel display="flex" ms="4px" fontSize="sm" fontWeight="500" mb="8px">
