...
const CommonCheckTable = (props) => {
  ...
  useEffect(() => {
    if (selectedColumns) {
      let tempCsvColumns = selectedColumns
            ...
            {ManageGrid !== false && (
              <Menu isLazy>
                ...
                <MenuList minW={"fit-content"} transform={"translate(1670px, 60px)"} zIndex={2}>
                  <MenuItem onClick={() => setManageColumns(true)} width={"165px"}>
                    {" "}
                    Manage Columns
                  </MenuItem>
            ...
            <Tbody {...getTableBodyProps()}>
              {isLoding ? (
                ...
                page?.map((row, i) => {
                  ...
                  return (
                    <Tr key={row?.id || rowProps?.key || i} {...rowProps}>
                            ...
                            if (item?.cell && typeof item?.cell === "function") {
                              data = (
                                <Flex
                                  Flex
                                  align="center"
                                  justifyContent={item?.Header === "Action" && "center"}
                                >
