...
import {
  ...
  FiLinkedin,
  FiMail,
  FiMessageCircle as _FiMessageCircle,
} from "react-icons/fi";
          ...
          <Box id="print-area" p={6}>
            <Flex gap={6} mb={6}>
              ...
              <Box flex={1}>
                ...
                <Flex gap={4}>
                  <Text>
                    <strong>{property?.numberofBedrooms}</strong> Beds
                  </Text>
                  <Text>
                    <strong>{property?.numberofBathrooms}</strong> Baths
                  </Text>
                  <Text>
                    <strong>{property?.squareFootage}</strong> Sq Ft
                  </Text>
                </Flex>
              </Box>
            </Flex>
          ...
          {favorites.map((property) => (
            ...
            >
              ...
              <Box p={3}>
                ...
                {notes[property._id] && (
                  <Box bg="yellow.50" p={2} borderRadius="md" mb={3} fontSize="sm">
