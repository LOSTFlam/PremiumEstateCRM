...
import { FiUpload, FiX, FiImage, FiStar, FiStar as FiStarOutline } from 'react-icons/fi';
import { postApi } from 'services/api';

export default function PropertyPhotoUpload({ propertyId, photos = [], onChange }) {
      ...
      {localPhotos.length > 0 && (
        <Stack spacing={3}>
          <HStack justify="space-between">
            <Text fontWeight="600">{t('publicListing.propertyImages')} ({localPhotos.length})</Text>
            <Badge colorScheme="green">
              {primaryImageIndex === 0 ? t('publicListing.primaryImageSet') : t('publicListing.clickStarToSetPrimary')}
            </Badge>
          </HStack>
