...
import {
  ...
  NumberInput,
  NumberInputField,
  NumberInputStepper as _NumberInputStepper,
  NumberIncrementStepper as _NumberIncrementStepper,
  NumberDecrementStepper as _NumberDecrementStepper,
  Slider,
  SliderFilledTrack,
  SliderThumb,
  SliderTrack,
...
export default function MortgageCalculator({ propertyPrice, isOpen, onClose }) {
  ...
  const calculations = useMemo(() => {
    ...
    const totalMonthlyPayment =
      monthlyPrincipalInterest + monthlyPropertyTax + monthlyInsurance + hoaFees;
        ...
        <ModalBody>
          <Grid templateColumns={{ base: "1fr", lg: "1fr 1fr" }} gap={8}>
            ...
            <Box>
              ...
              {/* Down Payment */}
              <FormControl mb={4}>
                <FormLabel fontWeight="600">Down Payment ({downPaymentPercent}%)</FormLabel>
                <Slider
            ...
            <Box>
              ...
              <Box bg="blue.500" color="white" p={6} borderRadius="xl" mb={6} textAlign="center">
              ...
              <Box bg={bgColor} borderWidth="1px" borderRadius="xl" p={4} borderColor={borderColor}>
                <Flex justify="space-between" mb={3} pb={3} borderBottomWidth="1px">
                  ...
                  <Text fontWeight="bold">
                    {formatCurrency(calculations.monthlyPrincipalInterest)}
                  </Text>
                </Flex>
                <Flex justify="space-between" mb={3} pb={3} borderBottomWidth="1px">
              ...
              <Box>
                ...
                <Grid templateColumns="1fr 1fr" gap={4}>
                  ...
                  <Box bg="gray.50" p={4} borderRadius="lg">
                    ...
                    <Text fontSize="xl" fontWeight="bold">
                      {calculations.loanToValue.toFixed(1)}%
                    </Text>
                  </Box>
                </Grid>
              </Box>
