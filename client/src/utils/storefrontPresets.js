...
const PRESET_META = {
  ...
  plots: {
    ...
    title: { ru: "Участки под строительство и девелопмент", en: "Plots for development and construction" },
    description: {
...
export const getStorefrontPresetBySlug = (presets = [], slug = "") => {
  ...
  return source.find((preset) => preset.slug === targetSlug) || DEFAULT_STOREFRONT_PRESETS.find((preset) => preset.slug === targetSlug) || null;
};
