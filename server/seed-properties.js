...
const enrichProperty = (property, ownerId) => {
  ...
  return {
    ...
    ...property,
    propertyPhotos: buildPhotoSet(property.propertyType, `${publicSlug}-photos`, 3),
    floorPlans: buildPhotoSet("floorPlan", `${publicSlug}-plan`, 1),
    createdDate,
    updatedDate: new Date(),
  };
};
